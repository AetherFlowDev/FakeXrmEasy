...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.Issues
{
    public class Issue191
    {
        ...
        public void Testing_191()
        {
            ...
            Assert.AreEqual(true, results.Entities[0].Attributes.ContainsKey("child1.contactid"));
            Assert.AreEqual(true, results.Entities[0].Attributes.ContainsKey("pet1.childid")); //test fails unless link22 is Inner join
        }
    }
}