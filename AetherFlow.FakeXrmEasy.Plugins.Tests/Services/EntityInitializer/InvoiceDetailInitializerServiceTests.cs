...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.Services.EntityInitializer
{
    public class InvoiceDetailInitializerServiceTests
    {
        ...
        public void No_Invoice_And_Price_Overriden_Is_False_Result_0()
        {
            ...
            Assert.AreEqual(new Money(0m), testPostCreate["priceperunit"]);
            Assert.AreEqual(1m, testPostCreate["quantity"]);
            Assert.AreEqual(new Money(0m), testPostCreate["amount"]);
            Assert.AreEqual(new Money(0m), testPostCreate["extendedamount"]);
        }
        ...
        public void Invoice_And_Price_Overriden_Is_False_Result_0()
        {
            ...
            Assert.AreEqual(new Money(0m), testPostInvoiceCreate["totalamount"]);
        }
        ...
        public void Invoice_Product_Pricelist_UoM_And_Price_Overriden_Is_False_Price_Is_In_ProductPriceLevel()
        {
            ...
            context.Initialize(initialEntities);
            Entity testPostCreate = service.Retrieve(invoiceDetail.LogicalName, invoiceDetail.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(10m), testPostCreate["priceperunit"]);
            Assert.AreEqual(1m, testPostCreate["quantity"]);
            Assert.AreEqual(new Money(10m), testPostCreate["amount"]);
            Assert.AreEqual(new Money(10m), testPostCreate["extendedamount"]);

            Entity testPostInvoiceCreate = service.Retrieve(invoice.LogicalName, invoice.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(10m), testPostInvoiceCreate["totalamount"]);
        }
        ...
        public void Invoice_Product_Pricelist_And_Price_Overriden_Is_False_Price_Is_In_ProductPriceLevel_UoM_In_Product()
        {
            ...
            Assert.AreEqual(new Money(10m), testPostCreate["amount"]);
            Assert.AreEqual(new Money(10m), testPostCreate["extendedamount"]);
            Assert.AreEqual(uom.ToEntityReference(), testPostCreate["uomid"]);
        ...
        public void Invoice_Product_Pricelist_UoM_And_Price_Overriden_Is_False_Price_Is_In_ProductPriceLevel_Quantity_3()
        {
            ...
            Entity testPostCreate = service.Retrieve(invoiceDetail.LogicalName, invoiceDetail.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(10m), testPostCreate["priceperunit"]);
            Assert.AreEqual(3m, testPostCreate["quantity"]);
            Assert.AreEqual(new Money(3m * 10m), testPostCreate["amount"]);
            Assert.AreEqual(new Money(3m * 10m), testPostCreate["extendedamount"]);

            Entity testPostInvoiceCreate = service.Retrieve(invoice.LogicalName, invoice.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(3m * 10m), testPostInvoiceCreate["totalamount"]);
        }
        ...
        public void Invoice_Product_Pricelist_UoM_And_Price_Overriden_Is_False_Price_Is_In_ProductPriceLevel_Quantity_3_ManualDiscount_Tax()
        {
            ...
            Assert.AreEqual(3m, testPostCreate["quantity"]);
            Assert.AreEqual(new Money(3m * 10m), testPostCreate["amount"]);
            Assert.AreEqual(new Money(3m * 10m - 12m + 3m), testPostCreate["extendedamount"]);

            Entity testPostInvoiceCreate = service.Retrieve(invoice.LogicalName, invoice.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(3m * 10m - 12m + 3m), testPostInvoiceCreate["totalamount"]);
        }
        ...
        public void Invoice_Product_Pricelist_UoM_And_Price_Overriden_Is_False_Price_Is_In_ProductPriceLevel_Quantity_3_AddsAmountToInvoice()
        {
            ...
            Entity testPostInvoiceCreate = service.Retrieve(invoice.LogicalName, invoice.Id, new ColumnSet(true));
            Assert.AreEqual(new Money(40m + 3m * 10m), testPostInvoiceCreate["totalamount"]);
        }
