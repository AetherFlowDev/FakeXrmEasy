...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests
{
    public class FakeContextTestPlugins
    {
        ...
        public void When_A_Plugin_Is_Executed_Configurations_Can_Be_Used()
        {
            ...
            Assert.AreEqual((string)target["unsecure"], unsecureConfiguration);
            Assert.AreEqual((string)target["secure"], secureConfiguration);
        }
        ...
        public void When_A_Plugin_Is_Executed_With_And_Instance_That_one_is_executed()
        {
            ...
            Assert.AreEqual("Property Updated", plugin.Property);
        }
        ...
        public void When_OrganizationName_Set()
        {
            ...
            Assert.AreEqual("TestOrgName", pluginCtx.OutputParameters["OrgName"]);
        }
        ...
        public void When_passing_preentityimages_it_gets_added_to_context()
        {
            ...
            Assert.AreEqual(1, preImagesReturned?.Count);
            Assert.IsInstanceOf<Entity>(preImagesReturned["PreImage"]);
        }
        ...
        public void When_passing_postentityimages_it_gets_added_to_context()
        {
            ...
            Assert.AreEqual(1, postImagesReturned?.Count);
            Assert.IsInstanceOf<Entity>(postImagesReturned["PostImage"]);
        }
    }
}