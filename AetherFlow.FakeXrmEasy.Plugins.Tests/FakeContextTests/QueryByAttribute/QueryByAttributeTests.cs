...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.QueryByAttributeTests
{
    public class Tests
    {
        [Test]
        public static void Order_is_respected_for_query_by_attribute()
        {
            ...
            Assert.AreEqual("Young", ordered[0].LastName);
            Assert.AreEqual("Old", ordered[1].LastName);
        }
        ...
        public static void When_a_query_by_attribute_is_executed_with_one_attribute_right_result_is_returned()
        {
            ...
            Assert.AreEqual(entityList[0]["name"].ToString(), "Test");
        }
        ...
        public static void Return_total_record_count_is_respected_for_query_by_attribute()
        {
            ...
            Assert.AreEqual(2, results.TotalRecordCount);
        }
    }
}