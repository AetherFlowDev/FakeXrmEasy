...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.ExecuteMultipleRequestTests
{
    public class ExecuteMultipleRequestTests
    {
        ...
        public static void Should_Execute_Subsequent_Requests_In_Order()
        {
            ...
            Assert.AreEqual("Acc1 - Updated", acc1.Name);
            Assert.AreEqual("Acc2 - Updated", acc2.Name);
        }
