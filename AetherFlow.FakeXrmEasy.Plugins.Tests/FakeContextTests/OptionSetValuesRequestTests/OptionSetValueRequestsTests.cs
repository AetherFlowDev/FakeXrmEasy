...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.OptionSetValuesRequestTests
{
    public class OptionSetValueRequestsTests
    {
        ...
        public void When_calling_insert_option_set_value_for_global_optionset_optionmetadata_contains_it()
        {
            ...
            Assert.AreEqual("Yeah! This is a fake label!", option.Label.LocalizedLabels[0].Label);
        }
