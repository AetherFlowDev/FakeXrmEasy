...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.LinqTests
{
    /// <summary>
    ...
    public class EqualityWithDifferentDataTypesTests
    {
        ...
        public void When_querying_option_sets_with_string_values_right_result_is_returned()
        {
            ...
            Assert.AreEqual(23, (result.Entities[0] as Account).IndustryCode.Value);
        }
        ...
        //    Assert.AreEqual(1, result.Entities.Count);
        //    Assert.AreEqual(AccountState.Inactive, (result.Entities[0] as Account).StateCode.Value);
        //}
    }
}