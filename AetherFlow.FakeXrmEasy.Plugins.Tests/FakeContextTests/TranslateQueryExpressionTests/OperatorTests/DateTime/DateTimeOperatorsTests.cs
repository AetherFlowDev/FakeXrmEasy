...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.TranslateQueryExpressionTests.OperatorTests.DateTimes
{
    public class DateTimeOperatorsTests
    {
        ...
        public void When_executing_a_query_expression_with_older_than_x_months_and_null_right_result_is_returned()
        {
            ...
            Assert.AreEqual(contact2.Id, collection.Entities[0].Id);
        }
