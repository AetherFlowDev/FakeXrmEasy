...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.FetchXml
{
    ...
    public class ConditionOperatorTests
    {
        ...
        public void FetchXml_Operator_Eq()
        {
            ...
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Equal, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_Ne()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NotEqual, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_Like()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Contains, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_NotBeginWith()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.DoesNotBeginWith, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_Like_As_EndsWith()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.EndsWith, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_NotEndWith()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.DoesNotEndWith, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_NotLike()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.DoesNotContain, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
        }
        ...
        public void FetchXml_Operator_In()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.In, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
            Assert.AreEqual("Iniesta", query.Criteria.Conditions[0].Values[1].ToString());
        }
        ...
        public void FetchXml_Operator_NotIn()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NotIn, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual("Messi", query.Criteria.Conditions[0].Values[0].ToString());
            Assert.AreEqual("Iniesta", query.Criteria.Conditions[0].Values[1].ToString());
        }
        ...
        public void FetchXml_Operator_In_MultiSelectOptionSet()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("new_multiselectattribute", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.In, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(1, query.Criteria.Conditions[0].Values[0]);
            Assert.AreEqual(2, query.Criteria.Conditions[0].Values[1]);
        }
        ...
        public void FetchXml_Operator_Null()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Null, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        }
        ...
        public void FetchXml_Operator_NotNull()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("fullname", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NotNull, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        }
        ...
        public void FetchXml_Operator_Gt_Translation()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("address1_longitude", query.Criteria.Conditions[0].AttributeName);
        ...
        public void FetchXml_Operator_Gt_Execution()
        {
            ...
            Assert.AreEqual(1.33, collection.Entities[0]["address1_longitude"]);
        }
        ...
        public void FetchXml_Operator_Ge_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("address1_longitude", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.GreaterEqual, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(1.2345, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Months_Translation()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXMonths, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Months_Execution()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXMonths, query.Criteria.Conditions[0].Operator);
            ...
            Assert.AreEqual(retrievedUser, ct3.Id);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Minutes_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXMinutes, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Hours_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXHours, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Days_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXDays, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Weeks_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXWeeks, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Older_Than_X_Years_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.OlderThanXYears, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Last_Seven_Days_Translation()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("createdon", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Last7Days, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        }
        ...
        public void FetchXml_Operator_Last_Seven_Days_Execution()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            Assert.AreEqual(ct1.Id, collection.Entities[0].Id);
        }
        ...
        public void FetchXml_Operator_Ge_Execution()
        {
            ...
            Assert.AreEqual(1.33, collection.Entities[0]["address1_longitude"]);
            Assert.AreEqual(1.2345, collection.Entities[1]["address1_longitude"]);
        }
        ...
        public void FetchXml_Operator_Lt_Execution()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            Assert.AreEqual(1.23, collection.Entities[0]["address1_longitude"]);
        }
        ...
        public void FetchXml_Operator_Le_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("address1_longitude", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LessEqual, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(1.2345, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_On_Translation()
        {
            ...
            Assert.AreEqual(ConditionOperator.On, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(2014, date.Value.Year);
            Assert.AreEqual(11, date.Value.Month);
            Assert.AreEqual(23, date.Value.Day);
        }
        ...
        public void FetchXml_Operator_On_Execution()
        {
            ...
            Assert.AreEqual(2014, retrievedDate.Value.Year);
            Assert.AreEqual(11, retrievedDate.Value.Month);
            Assert.AreEqual(23, retrievedDate.Value.Day);
        }
        ...
        public void FetchXml_Operator_On_Or_Before_Execution()
        {
            ...
            Assert.AreEqual(23, retrievedDateFirst.Value.Day);
            Assert.AreEqual(22, retrievedDateSecond.Value.Day);
        }
        ...
        public void FetchXml_Operator_On_Or_After_Execution()
        {
            ...
            var retrievedDateSecond = collection.Entities[1]["anniversary"] as DateTime?;
            Assert.AreEqual(23, retrievedDateFirst.Value.Day);
            Assert.AreEqual(24, retrievedDateSecond.Value.Day);
        }
        ...
        public void FetchXml_Operator_Today_Execution()
        {
            ...
            var retrievedDate = collection.Entities[0]["anniversary"] as DateTime?;
            Assert.AreEqual(retrievedDate, DateTime.Today);
        }
        ...
        public void FetchXml_Operator_Yesterday_Execution()
        {
            ...
            var retrievedDate = collection.Entities[0]["anniversary"] as DateTime?;
            Assert.AreEqual(retrievedDate, DateTime.Today.AddDays(-1));
        }
        ...
        public void FetchXml_Operator_Between_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Between, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(new DateTime(2013, 5, 17), query.Criteria.Conditions[0].Values[0]);
            Assert.AreEqual(new DateTime(2013, 5, 20, 14, 40, 0), query.Criteria.Conditions[0].Values[1]);
        }
        ...
        public void FetchXml_Operator_Between_Execution()
        {
            ...
            var retrievedDate = collection.Entities[0]["anniversary"] as DateTime?;
            Assert.AreEqual(retrievedDate, new DateTime(2013, 05, 19));
        }
        ...
        public void FetchXml_Operator_NotBetween_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NotBetween, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(new DateTime(2013, 5, 17), query.Criteria.Conditions[0].Values[0]);
            Assert.AreEqual(new DateTime(2013, 5, 20, 14, 40, 0), query.Criteria.Conditions[0].Values[1]);
        }
        ...
        public void FetchXml_Operator_NotBetween_Execution()
        {
            ...
            var retrievedDate = collection.Entities[0]["anniversary"] as DateTime?;
            Assert.AreEqual(retrievedDate, date);
        }
        ...
        public void FetchXml_Operator_ThisYear_Execution()
        {
            ...
            Assert.AreEqual(3, collection.Entities.Count);

            Assert.AreEqual(((DateTime)collection.Entities[0]["anniversary"]).Year, thisYear);
            Assert.AreEqual(((DateTime)collection.Entities[1]["anniversary"]).Year, thisYear);
            Assert.AreEqual(((DateTime)collection.Entities[2]["anniversary"]).Year, thisYear);
        }
        ...
        public void FetchXml_Operator_ThisMonth_Execution()
        {
            ...
            Assert.AreEqual(((DateTime)collection.Entities[0]["anniversary"]).Month, thisMonth);
            Assert.AreEqual(((DateTime)collection.Entities[1]["anniversary"]).Month, thisMonth);
            Assert.AreEqual(((DateTime)collection.Entities[2]["anniversary"]).Month, thisMonth);
        }
        ...
        public void FetchXml_Operator_LastMonth_Execution()
        {
            ...
            Assert.AreEqual(((DateTime)collection.Entities[0]["anniversary"]).Month, lastMonth);
            Assert.AreEqual(((DateTime)collection.Entities[1]["anniversary"]).Month, lastMonth);
        }
        ...
        public void FetchXml_Operator_NextMonth_Execution()
        {
            ...
            Assert.AreEqual(((DateTime)collection.Entities[0]["anniversary"]).Month, nextMonth);
            Assert.AreEqual(((DateTime)collection.Entities[1]["anniversary"]).Month, nextMonth);
        }
        ...
        public void FetchXml_Operator_LastYear_Execution()
        {
            ...
            Assert.AreEqual(((DateTime)collection.Entities[0]["anniversary"]).Year, thisYear - 1);
            Assert.AreEqual(((DateTime)collection.Entities[1]["anniversary"]).Year, thisYear - 1);
            Assert.AreEqual(((DateTime)collection.Entities[2]["anniversary"]).Year, thisYear - 1);
        }
        ...
        public void FetchXml_Operator_EqUserId_Translation()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("systemuserid", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.EqualUserId, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        }
        ...
        public void FetchXml_Operator_EqUserId_Execution()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            var retrievedUser = collection.Entities[0].Id;
            Assert.AreEqual(retrievedUser, su1.Id);
        }
        ...
        public void FetchXml_Operator_NeUserId_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("systemuserid", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NotEqualUserId, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        }
        ...
        public void FetchXml_Operator_NeUserId_Execution()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            var retrievedUser = collection.Entities[0].Id;
            Assert.AreEqual(retrievedUser, su2.Id);
        }
        [Test]
        ...
        public void FetchXml_Operator_Next_Seven_Days_Execution()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.Next7Days, query.Criteria.Conditions[0].Operator);
        ...
        public void FetchXml_Operator_Last_Week_Execution()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastWeek, query.Criteria.Conditions[0].Operator);
        ...
        public void FetchXml_Operator_This_Week_Execution()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.ThisWeek, query.Criteria.Conditions[0].Operator);
        ...
        public void FetchXml_Operator_Next_Week_Execution()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("anniversary", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextWeek, query.Criteria.Conditions[0].Operator);
        ...
        public void FetchXml_Operator_ContainValues_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("new_multiselectattribute", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.ContainValues, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(2, query.Criteria.Conditions[0].Values.Count);
            Assert.AreEqual(1, query.Criteria.Conditions[0].Values[0]);
            Assert.AreEqual(2, query.Criteria.Conditions[0].Values[1]);
        }
        ...
        public void FetchXml_Operator_DoesNotContainValues_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("new_multiselectattribute", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.DoesNotContainValues, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(2, query.Criteria.Conditions[0].Values.Count);
            Assert.AreEqual(1, query.Criteria.Conditions[0].Values[0]);
            Assert.AreEqual(2, query.Criteria.Conditions[0].Values[1]);
        }
        ...
        public void FetchXml_Operator_DoesNotContainValues_Execution()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            Assert.AreEqual(ct2.Id, collection.Entities[0].Id);
        }
        ...
        public void FetchXml_EntityName_Attribute_Translation()
        {
            ...
            Assert.True(query.Criteria != null);
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("currentcost", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual("product", query.Criteria.Conditions[0].EntityName);
            Assert.AreEqual(ConditionOperator.Null, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(0, query.Criteria.Conditions[0].Values.Count);
        ...
        public void FetchXml_Operator_Last_X_Hours_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastXHours, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Next_X_Hours_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextXHours, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Last_X_Days_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastXDays, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Next_X_Days_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextXDays, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Last_X_Weeks_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastXWeeks, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Next_X_Weeks_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextXWeeks, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Last_X_Months_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastXMonths, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Next_X_Months_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextXMonths, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Last_X_Years_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.LastXYears, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
        ...
        public void FetchXml_Operator_Next_X_Years_Translation()
        {
            ...
            Assert.AreEqual(1, query.Criteria.Conditions.Count);
            Assert.AreEqual("birthdate", query.Criteria.Conditions[0].AttributeName);
            Assert.AreEqual(ConditionOperator.NextXYears, query.Criteria.Conditions[0].Operator);
            Assert.AreEqual(3, query.Criteria.Conditions[0].Values[0]);
        }
