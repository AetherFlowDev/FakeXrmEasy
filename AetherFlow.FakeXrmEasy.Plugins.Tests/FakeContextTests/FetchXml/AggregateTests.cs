...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.FetchXml
{
    public class AggregateTests
    {
        ...
        public void FetchXml_Aggregate_Group_EntityReference_Count()
        {
            ...
            Assert.AreEqual(2, biggestGroup.GetAttributeValue<AliasedValue>("Qt").Value);
        }
        ...
        public void FetchXml_Aggregate_CountDistinct()
        {
            ...
            Assert.AreEqual(3, ent.GetAttributeValue<AliasedValue>("count")?.Value);
        }
        ...
        public void FetchXml_Aggregate_Sum_Int()
        {
            ...
            Assert.AreEqual(3, ent.GetAttributeValue<AliasedValue>("sum")?.Value);
        }
        ...
        public void FetchXml_Aggregate_Sum_Money()
        {
            ...
            Assert.IsInstanceOf(typeof(Money), ent.GetAttributeValue<AliasedValue>("sum")?.Value);
            Assert.AreEqual(200m, (ent.GetAttributeValue<AliasedValue>("sum")?.Value as Money)?.Value);
        }
        ...
        public void FetchXml_Aggregate_Dategroup_Year()
        {
            ...
            Assert.AreEqual(new int?[] { 1980, 1981 }, byYear.Keys.OrderBy(x => x));

            Assert.AreEqual(2, byYear[1980].GetAttributeValue<AliasedValue>("count.contacts").Value);
            Assert.AreEqual(2, byYear[1981].GetAttributeValue<AliasedValue>("count.contacts").Value);
        }
        ...
        public void FetchXml_Aggregate_Dategroup_Month()
        {
            ...
            Assert.AreEqual(new int?[] { 1, 2, 5 }, byMonth.Keys.OrderBy(x => x));

            Assert.AreEqual(2, byMonth[1].GetAttributeValue<AliasedValue>("count.contacts").Value);
            Assert.AreEqual(1, byMonth[2].GetAttributeValue<AliasedValue>("count.contacts").Value);
            Assert.AreEqual(1, byMonth[5].GetAttributeValue<AliasedValue>("count.contacts").Value);
        }
        ...
        public void FetchXml_Aggregate_Dategroup_Quarter()
        {
            ...
            Assert.AreEqual(new int?[] { 1, 2 }, byQuarter.Keys.OrderBy(x => x));

            Assert.AreEqual(3, byQuarter[1].GetAttributeValue<AliasedValue>("count.contacts").Value);
            Assert.AreEqual(1, byQuarter[2].GetAttributeValue<AliasedValue>("count.contacts").Value);
        }
        ...
        public void FetchXml_Aggregate_Dategroup_Day()
        {
            ...
            Assert.AreEqual(new int?[] { 1, 2 }, byDay.Keys.OrderBy(x => x));

            Assert.AreEqual(2, byDay[1].GetAttributeValue<AliasedValue>("count.contacts").Value);
            Assert.AreEqual(2, byDay[2].GetAttributeValue<AliasedValue>("count.contacts").Value);
        }
        ...
        public void FetchXml_Aggregate_OrderByGroup()
        {
            ...
            Assert.AreEqual(3, collection.Entities.Count);
            Assert.AreEqual(new int?[] { 1, 2, 5 }, collection.Entities.Select(x => x.GetAttributeValue<AliasedValue>("month")?.Value as int?));
        }
        ...
        public void FetchXml_Aggregate_OrderByGroupDescending()
        {
            ...
            Assert.AreEqual(3, collection.Entities.Count);
            Assert.AreEqual(new int?[] { 5, 2, 1 }, collection.Entities.Select(x => x.GetAttributeValue<AliasedValue>("month")?.Value as int?));
        }
        ...
        public void FetchXml_Aggregate_OrderByAggregate()
        {
            ...
            Assert.AreEqual(3, collection.Entities.Count);
            Assert.AreEqual(new int?[] { 1, 1, 2 }, collection.Entities.Select(x => x.GetAttributeValue<AliasedValue>("count")?.Value as int?));
        }
        ...
        public void FetchXml_Aggregate_NoRows_NoGroups_Count()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            Assert.AreEqual(0, collection.Entities.First().GetAttributeValue<AliasedValue>("count.contacts")?.Value);
        }
        ...
        public void FetchXml_Aggregate_NoRows_NoGroups_Sum()
        {
            ...
            Assert.AreEqual(1, collection.Entities.Count);
            Assert.AreEqual(1, collection.Entities.First().Attributes.Count);
        ...
        public void FetchXml_Aggregate_Min_Date()
        {
            ...
            Assert.AreEqual(new DateTime(2011, 01, 01), result.Entities.Single().GetAttributeValue<AliasedValue>("minvalue").Value);
        }
        ...
        public void FetchXml_Aggregate_Max_Date()
        {
            ...
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(1, result.Entities.Count);
            Assert.AreEqual(new DateTime(2011, 01, 03), result.Entities.Single().GetAttributeValue<AliasedValue>("maxvalue").Value);
        }
        ...
        public void FetchXml_Aggregate_Min_With_Nulls()
        {
            ...
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(1, result.Entities.Count);
            Assert.AreEqual(1, result.Entities.Single().GetAttributeValue<AliasedValue>("minvalue").Value);
        }
        ...
        public void FetchXml_Aggregate_Max_With_Nulls()
        {
            ...
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(1, result.Entities.Count);
            Assert.AreEqual(-0.5m, result.Entities.Single().GetAttributeValue<AliasedValue>("maxvalue").Value);
        }
        ...
        public void FetchXml_Aggregate_Avg_With_Nulls()
        {
            ...
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(1, result.Entities.Count);
            Assert.AreEqual(-1.5m, result.Entities.Single().GetAttributeValue<AliasedValue>("avgvalue").Value);
        }
    ...
    <link-entity name='salesorder' from='customerid' to='contactid' alias='sales12m' link-type='inner'>
        ...
        <filter type='and'>
	      <condition attribute='datefulfilled' operator='on-or-before' value='2019-02-01' />
            ...
            Assert.AreEqual(10m, ((Money)value.Value).Value);
        }
