...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.ExecuteFetchRequestTests
{
    public class ExecuteFetchRequestTests
    {
        ...
        public void Test_Conversion_DateTime_ToXml()
        {
            ...
            Assert.AreEqual($"<new_startdate date=\"2011-07-12\" time=\"01:12 {localizedAMPMDesignator}\">2011-07-12T13:12:43{utcOffset}:00</new_startdate>", element.ToString());
        }
        ...
        public void Test_Conversion_AlliasedDateTime_ToXml()
        {
            ...
            var localizedAMPMDesignator = date.ToString("tt"); //Spanish and other cultures don't have the AM/PM designator
            Assert.NotNull(element);
            Assert.AreEqual($"<alias.new_startdate date=\"2011-07-12\" time=\"01:12 {localizedAMPMDesignator}\">2011-07-12T13:12:43{utcOffset}:00</alias.new_startdate>", element.ToString());
        }
        ...
        public void Test_Conversion_EntityReference_ToXml()
        {
            ...
            Assert.NotNull(element);
            Assert.AreEqual(@"<new_contact dsc=""0"" yomi=""John Doe"" name=""John Doe"" type=""2"">" + contactGuid.ToString().ToUpper() + "</new_contact>", element.ToString());
        }
        ...
        public void Test_Conversion_OptionSetValue_ToXml()
        {
            ...
            Assert.NotNull(element);
            Assert.AreEqual(@"<new_contact name=""Test"" formattedvalue=""1"">1</new_contact>", element.ToString());
        }
        ...
        public void Test_Conversion_OptionSetValueCollection_ToXml()
        {
            ...
            var element = executor.AttributeValueToFetchResult(
                ...
                fake);
            Assert.NotNull(element);
            Assert.AreEqual(@"<new_multiselectattribute name=""[-1,1,2,-1]"">[-1,1,2,-1]</new_multiselectattribute>", element.ToString());
        }
        ...
        public void When_executing_fetchxml_right_result_is_returned()
        {
            ...
            Assert.IsNotEmpty(response.FetchXmlResult);
        ...
        public void When_executing_fetchxml_with_paging_cookies_correct_page_is_returned()
        {
            ...
            Assert.AreEqual(7, rows.Count());
            Assert.AreEqual("1", resXml.Element("resultset").Attribute("morerecords").Value);
            ...
            Assert.IsNotEmpty(response2.FetchXmlResult);
            ...
            Assert.IsNotEmpty(response3.FetchXmlResult);
            ...
            Assert.AreEqual("0", resXml.Element("resultset").Attribute("morerecords").Value);
        }
        ...
        public void When_querying_fetchxml_with_linked_entities_with_left_outer_join_right_result_is_returned()
        {
            ...
            Assert.AreEqual(1, rowsWithLinkedData.Count());
        }
        ...
        public void When_querying_fetchxml_with_multiple_linked_entities_with_the_same_entity_right_result_is_returned()
        {
            ...
            Assert.AreEqual(3, linkedAttributes.Count());

            Assert.AreEqual(1, linkedAttributes.Count(e => e.Value == "User2"));
            Assert.AreEqual(1, linkedAttributes.Count(e => e.Value == "User3"));
            Assert.AreEqual(1, linkedAttributes.Count(e => e.Value == "User4"));
        }
    }
}