...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests
{
    public class RetrieveRequestTests
    {
        ...
        public static void Should_Populate_EntityReference_Name_When_Metadata_Is_Provided()
        {
            ...
            Assert.AreEqual("Fake XrmEasy", account.GetAttributeValue<EntityReference>("ownerid").Name);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity()
        {
            ...
            Assert.AreEqual(account2.Id, resultAccount.Id);
            Assert.AreEqual(account2.Name, resultAccount.Name);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_1_To_N_Related_Records()
        {
            ...
            Assert.AreEqual(2, resultAccount.contact_customer_accounts.Count());
            ...
            Assert.AreEqual(contact1.FirstName, resultRelatedRecordsList.First(x => x.Id == contact1.Id).FirstName);
            Assert.AreEqual(contact3.FirstName, resultRelatedRecordsList.First(x => x.Id == contact3.Id).FirstName);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_N_To_N_Related_Records()
        {
            ...
            Assert.AreEqual(3, resultAccount.accountleads_association.Count());
            ...
            Assert.AreEqual(lead2.Subject, resultRelatedRecordsList.First(x => x.Id == lead2.Id).Subject);
            Assert.AreEqual(lead4.Subject, resultRelatedRecordsList.First(x => x.Id == lead4.Id).Subject);
            Assert.AreEqual(lead5.Subject, resultRelatedRecordsList.First(x => x.Id == lead5.Id).Subject);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_N_To_N_Related_Records_Vice_Versa()
        {
            ...
            Assert.AreEqual(lead2.Id, lead2.Id);
            Assert.AreEqual(lead2.Subject, lead2.Subject);

            //check relationship
            Assert.NotNull(resultLead.accountleads_association);
            Assert.AreEqual(2, resultLead.accountleads_association.Count());
            ...
            Assert.AreEqual(account2.Name, resultRelatedRecordsList.First(x => x.Id == account2.Id).Name);
            Assert.AreEqual(account1.Name, resultRelatedRecordsList.First(x => x.Id == account1.Id).Name);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_Multiple_Related_Record_Queries()
        {
            ...
            Assert.NotNull(resultAccount.accountleads_association);
            Assert.AreEqual(2, resultAccount.accountleads_association.Count());
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_Relationship_Early_Bound()
        {
            ...
            //check contacts (optional check)
            Assert.AreEqual(contact1["firstname"], relatedEntities.First(x => x.Id == contact1.Id)["firstname"]);
            Assert.AreEqual(contact3["firstname"], relatedEntities.First(x => x.Id == contact3.Id)["firstname"]);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_1_To_N_Related_Records_And_Related_Record_Query_Criteria()
        {
            ...
            Assert.NotNull(resultAccount.contact_customer_accounts);
            Assert.AreEqual(1, resultAccount.contact_customer_accounts.Count());
            Assert.AreEqual(contact3.Id, resultAccount.contact_customer_accounts.First().Id);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_With_N_To_N_Related_Records_And_Related_Record_Query_Criteria()
        {
            ...
            Assert.NotNull(resultAccount.accountleads_association);
            Assert.AreEqual(1, resultAccount.accountleads_association.Count());
            Assert.AreEqual(lead3.Id, resultAccount.accountleads_association.First().Id);
        }
        ...
        public static void Should_Retrieve_All_Related_Records()
        {
            ...
            Assert.NotNull(resultAccount.accountleads_association);
            //The
            Assert.AreEqual(20, resultAccount.accountleads_association.Count());
        }
        ...
        public static void Should_Throw_When_Related_Record_Query_Not_Set_For_Relationship()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => fakedService.Execute(request));
            Assert.AreEqual("relateEntitiesQuery.Value", exception.ParamName);
        }
        ...
        public static void Should_Throw_When_Relationship_Not_Set_In_Metadata()
        {
            ...
            Assert.AreEqual("Relationship \"any\" does not exist in the metadata cache.", exception.Message);
        }
        ...
        public static void Should_Retrieve_A_Correct_Entity_By_Alternate_Key()
        {
            ...
            Assert.AreEqual(account.Id, retrievedAccount.Entity.Id);
        }
        ...
        public static void Should_Throw_When_Alternate_Key_Not_In_Metadata()
        {
            ...
            Assert.AreEqual($"The requested key attributes do not exist for the entity {Account.EntityLogicalName}", exception.Message);
        }
    }
}