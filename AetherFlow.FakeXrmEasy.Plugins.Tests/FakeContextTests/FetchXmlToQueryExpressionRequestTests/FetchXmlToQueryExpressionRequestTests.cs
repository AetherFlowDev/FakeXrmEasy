...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.FetchXmlToQueryExpressionRequestTests
{
    public class FetchXmlToQueryExpressionRequestTests
    {
        ...
        public void Should_convert_fetchxml_query_into_queryexpression()
        {
            ...
            Assert.AreEqual("activitypointer", response.Query.EntityName);
        }
    }
}
