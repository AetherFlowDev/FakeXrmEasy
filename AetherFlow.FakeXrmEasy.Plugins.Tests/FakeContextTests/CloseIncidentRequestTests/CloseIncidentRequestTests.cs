...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.CloseIncidentRequestTests
{
    public class CloseIncidentRequestTests
    {
        ...
        public void When_a_request_is_called_Incident_Is_Resolved()
        {
            ...
            Assert.AreEqual(StatusProblemSolved, retrievedIncident.GetAttributeValue<OptionSetValue>("statuscode").Value);
            Assert.AreEqual((int)Crm.IncidentState.Resolved, retrievedIncident.GetAttributeValue<OptionSetValue>("statecode").Value);
        }
