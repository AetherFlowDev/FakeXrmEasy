...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests
{
    public class FakeContextTestUpdate
    {
        ...
        public void When_a_null_entity_is_updated_an_exception_is_thrown()
        {
            ...
            Assert.AreEqual(ex.Message, "The entity must not be null");
        }
        ...
        public void When_an_entity_is_updated_with_an_empty_guid_an_exception_is_thrown()
        {
            ...
            Assert.AreEqual("account with Id 00000000-0000-0000-0000-000000000000 Does Not Exist", ex.Message);
        }
        ...
        public void When_an_entity_is_updated_with_an_empty_logical_name_an_exception_is_thrown()
        {
            ...
            Assert.AreEqual("The entity logical name must not be null or empty.", ex.Message);
        }
        ...
        public void When_updating_an_entity_the_context_should_reflect_changes()
        {
            ...
            Assert.AreEqual(context.Data["account"][guid]["name"], "Before update");
            ...
            Assert.AreEqual(context.Data["account"][guid]["name"], "After update");
        }
        ...
        public void When_updating_an_optionsetvaluecollection_the_context_should_reflect_changes()
        {
            ...
            Assert.AreEqual(context.Data["contact"][guid]["new_multiselectattribute"], new OptionSetValueCollection() { new OptionSetValue(1) });
            ...
            Assert.AreEqual(context.Data["contact"][guid]["new_multiselectattribute"], new OptionSetValueCollection() { new OptionSetValue(2), new OptionSetValue(3) });
        }
        ...
        public void When_update_is_invoked_with_non_existing_entity_an_exception_is_thrown()
        {
            ...
            Assert.AreEqual(ex.Message, string.Format("account with Id {0} Does Not Exist", nonExistingGuid));
        }
        ...
        public void When_updating_an_entity_an_unchanged_attribute_remains_the_same()
        {
            ...
            Assert.AreEqual(account.AccountNumber, "69");
        }
        ...
        public void When_updating_an_entity_only_one_entity_is_updated()
        {
            ...
            Assert.AreEqual(account.Name, "Devil Customer");
        }
        ...
        public void When_updating_an_entity_using_organization_context_changes_should_be_saved()
        {
            ...
            Assert.AreEqual(account.Name, "Super Great Customer Name Updated!");
        }
        ...
        public void Should_Not_Change_Context_Objects_Without_Update()
        {
            ...
            Assert.AreEqual("Updated locally", firstRetrieve["accountname"]);
            Assert.AreEqual("Adventure Works", secondRetrieve["accountname"]);
        }
        ...
        public void Should_Not_Change_Context_Objects_Without_Update_And_Retrieve_Multiple()
        {
            ...
            Assert.AreEqual("Updated locally", firstRetrieve.Name);
            Assert.AreEqual("Adventure Works", secondRetrieve.Name);
        }
        ...
        public void Should_Not_Raise_An_Exception_When_Updating_Status()
        {
            ...
            Assert.AreEqual(1, (int)updatedAccount.StateCode.Value);
        }
        ...
        public void Should_Return_Updated_EntityReference_Name()
        {
            ...
            Assert.AreEqual("Good Job", account.GetAttributeValue<EntityReference>("ownerid").Name);
        }
    }
}