...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests
{
    public class QueryLinkEntityTests
    {
        ...
        public static void Should_Find_Faked_N_To_N_Records()
        {
            ...
            Assert.IsNotEmpty(result.Entities);
        ...
        public void Entities_Can_Be_Linked_On_String_Attribute()
        {
            ...
            Assert.AreEqual(1, queryResult.Entities.Count);
        }
        ...
        public void Should_Not_Throw_Unable_To_Cast_AliasedValue_Exception()
        {
            ...
            Assert.AreEqual(6, entities.Entities.Count);
        }
        ...
        public void When_There_Is_A_LinkedEntity_The_Output_EntityAlias_Should_Be_Suffixed_With_1()
        {
            ...
            Assert.AreEqual("User1", ((AliasedValue)resultingEntity["systemuser1.fullname"]).Value);
        }
...

        {
            ...
            var result = service.RetrieveMultiple(query);
            var resultingEntity = result.Entities[0];
            Assert.AreEqual(3, resultingEntity.Attributes.Count);
            Assert.AreEqual("User1", ((AliasedValue)resultingEntity["systemuser1.fullname"]).Value);
            Assert.AreEqual("BusinessUnit1", ((AliasedValue)resultingEntity["businessunit1.name"]).Value);
        }
        ...
        public void When_There_Are_Multiple_LinkedEntities_With_The_Same_Entitiy_The_Output_EntityAlias_Should_All_Be_Suffixed_With_Incrementally()
        {
            ...
            var resultingEntity = result.Entities[0];
            Assert.AreEqual(3, resultingEntity.Attributes.Count);
            Assert.AreEqual("User2", ((AliasedValue)resultingEntity["systemuser1.fullname"]).Value);
            Assert.AreEqual("User1", ((AliasedValue)resultingEntity["systemuser2.fullname"]).Value);
        }
        ...
        public void When_There_Are_Multiple_LinkedEntities_With_The_Same_Entitiy_And_One_Has_An_Alias_The_Output_EntityAlias_Should_All_Be_Suffixed_With_Incrementally_Ignoring_The_Aliased_One()
        {
            ...
            var result = service.RetrieveMultiple(query);
            var resultingEntity = result.Entities[0];
            Assert.AreEqual(4, resultingEntity.Attributes.Count);
            Assert.AreEqual("User3", ((AliasedValue)resultingEntity["systemuser1.fullname"]).Value);
            Assert.AreEqual("User2", ((AliasedValue)resultingEntity["systemuserwithalias.fullname"]).Value);
            Assert.AreEqual("User1", ((AliasedValue)resultingEntity["systemuser2.fullname"]).Value);
        }
        ...
        public void TestRetriveMultipleWithLinkEntityWithAlternateNullField()
        {
            ...
            Assert.AreEqual("entity1", entity1Name);
            Assert.AreEqual("value", entity1Value);
            ...
            // this works fine:
            Assert.AreEqual("entity2", entity2Name);

            // this fails (entity2Value is "value")
            Assert.AreEqual(null, entity2Value);
        }
    }
}