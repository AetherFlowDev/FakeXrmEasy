...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.RetrieveMultiple
{
    public class RetrieveMultipleTests
    {
        ...
        public void TestPaging()
        {
            ...
            Assert.AreEqual(context.MaxRetrieveCount, result.Entities.Count);
            ...
            allRecords.AddRange(result.Entities);
            Assert.AreEqual(excessNumberOfRecords, result.Entities.Count);
        ...
        public void TestTop()
        {
            ...
            query.TopCount = 5;
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(query.TopCount, result.Entities.Count);
            Assert.False(result.MoreRecords);
        }
        ...
        public void TestLinkCriteriaAreNotChanged()
        {
            ...
            Assert.AreEqual(ConditionOperator.Equal, query.LinkEntities[0].LinkCriteria.Conditions[0].Operator);
            Assert.AreEqual(true, query.LinkEntities[0].LinkCriteria.Conditions[0].Values[0]);
        }
        ...
        public void TestAskingForEmptyPage()
        {
            ...
            Assert.AreEqual(0, service.RetrieveMultiple(query).Entities.Count);
        }
        ...
        public void TestThatDistinctWorks()
        {
            ...
            Assert.AreEqual(1, service.RetrieveMultiple(query).Entities.Count);
        }
        ...
        public void TestThatDistinctWorksWithLinkEntityFields()
        {
            ...
            Assert.AreEqual(2, service.RetrieveMultiple(query).Entities.Count);
        }
        ...
        public void TestThatPageInfoTotalRecordCountWorksWithPaging()
        {
            ...
            EntityCollection result = service.RetrieveMultiple(query);
            Assert.AreEqual(10, result.Entities.Count);
            Assert.AreEqual(100, result.TotalRecordCount);
            Assert.True(result.MoreRecords);
            ...
            result = service.RetrieveMultiple(query);
            Assert.AreEqual(20, result.Entities.Count);
            Assert.AreEqual(100, result.TotalRecordCount);
            Assert.True(result.MoreRecords);
        }
        ...
        public void Should_Populate_EntityReference_Name_When_Metadata_Is_Provided()
        {
            ...
            Assert.AreEqual("Fake XrmEasy", accounts.Entities[0].GetAttributeValue<EntityReference>("ownerid").Name);
        }
        ...
        public void Should_Allow_Using_Aliases_with_Dot()
        {
            ...
            Assert.AreEqual("Jordi", accounts.Entities.First().GetAttributeValue<AliasedValue>("primary.contact.firstname").Value);
        }
        ...
        public void TheCorrectResultIsReturnedWhenUsingConditionOperatorInWithGuid()
        {
            ...
            Assert.AreEqual(contact.Id, result[0].Id);
        }
    }
}
