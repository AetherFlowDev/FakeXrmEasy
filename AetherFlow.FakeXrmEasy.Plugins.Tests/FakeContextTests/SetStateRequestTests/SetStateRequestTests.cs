...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.SetStateRequestTests
{
    public class SetStateRequestTests
    {
        ...
        public void When_set_state_request_is_called_an_entity_is_updated()
        {
            ...
            Assert.AreEqual((int)contact.StateCode.Value, 69);
            Assert.AreEqual((int)contact.StatusCode.Value, 6969);
        }
        ...
        public void Should_set_a_statecode_by_default_when_an_entity_record_is_added_to_the_context()
        {
            ...
            Assert.AreEqual((int)contact.StateCode.Value, 0); //Active
        }
        ...
        public void Should_not_override_a_statecode_already_initialized()
        {
            ...
            Assert.AreEqual((int)contact.StateCode.Value, 69); //Set
        }
    }
}