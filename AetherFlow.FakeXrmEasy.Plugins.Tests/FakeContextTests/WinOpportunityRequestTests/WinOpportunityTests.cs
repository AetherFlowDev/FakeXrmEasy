...
namespace AetherFlow.FakeXrmEasy.Plugins.Tests.FakeContextTests.WinOpportunityRequestTests
{
    public class WinOpportunityTests
    {
        ...
        public void Check_if_Opportunity_status_is_Win_after_set()
        {
            ...
            Assert.AreEqual(opp.StatusCode.Value, (int)OpportunityState.Won);
        }
    }
}